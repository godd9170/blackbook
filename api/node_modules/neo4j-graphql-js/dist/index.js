...
function cypherQuery(_ref2, context, resolveInfo) {
  ...
  var _Object$entries$reduc = (0, _entries2.default)(otherParams).reduce(function (_ref3, _ref4) {
  ...
  var argString = (0, _stringify2.default)(nonNullParams).replace(JSON_TO_PARAM_REGEX, '$1:');
...
function cypherMutation(_ref7, context, resolveInfo) {
  var _ref7$first = _ref7.first,
      ...
      _id = _ref7._id,
      otherParams = (0, _objectWithoutProperties3.default)(_ref7, ['first', 'offset', '_id']);
